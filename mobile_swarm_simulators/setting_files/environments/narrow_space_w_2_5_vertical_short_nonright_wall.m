...
envset_wall_segments(:,:,7) = [[envset_xmax,envset_ymin];[+L1_/2,envset_ymin]];
envset_wall_segments(:,:,8) = [[+L1_/2,envset_ymin];[+L2_/2,-L3_/2]];
envset_wall_segments(:,:,9) = [[+L2_/2,-L3_/2];[-L2_/2,-L3_/2]];
envset_wall_segments(:,:,10) = [[-L2_/2,-L3_/2];[-L1_/2,envset_ymin]];
envset_wall_segments(:,:,11) = [[-L1_/2,envset_ymin];[envset_xmin,envset_ymin]];
